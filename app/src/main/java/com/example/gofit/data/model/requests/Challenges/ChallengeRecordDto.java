...
public class ChallengeRecordDto {
    ...
    public ChallengeRecordDto(String creatorEmail, Challenge challenge, LocalDateTime dateAccepted, LocalDateTime dateStarted, LocalDateTime dateEnd, LocalDateTime dateLastCompleted, boolean isComplete, int streak, int totalDaysCompleted, int score) {
